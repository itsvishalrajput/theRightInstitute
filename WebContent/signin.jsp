...
<head>
    ...
    <title>Registration | The Right Institute</title>
...
<body class="homepage">
    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                <h2>Registration</h2>
                <p class="lead">Sign up now to search what you're looking for.</p>
            </div> 
                ...
                <form method="post" action="sign-in">
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="pswrd" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Re-enter Password *</label>
                            <input type="password" name="pswrdAgain" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Email *</label>
