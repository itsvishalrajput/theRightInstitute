...
<head>
    ...
    <title>Login | The Right Institute</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
						...
						%>
                        <li><a href="signin.jsp">Register Now</a></li>
                        <%} else { %>
                              ...
                              <div class="carousel-content">
                                   <form id="main-login-form" class="login-form" name="login-form" method="post" action="login">
                                    <h3 class="animation animated-item-1">
                                    	<input type="text" name="uname" class="form-control" placeholder="Enter the Username" required="required"></h3>
                                    <h3 class="animation animated-item-2">
                            			<input type="password" name="pswd" class="form-control" placeholder="Enter the Password" required="required"></h3>
                                    <h3 class="btn-slide animation animated-item-3">
                                    	<button type="submit" name="submit" class="btn btn-primary btn-lg">Login to <b>The Right Institute</b></button></h3>
                                    </form>
                             </div>
                        </div>
                </div>
